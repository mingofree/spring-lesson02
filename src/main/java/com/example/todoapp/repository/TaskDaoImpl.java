...
import com.example.todoapp.entity.TaskType;
...
public class TaskDaoImpl implements TaskDao {
  ...
  public List<Task> findByType(int typeId) {
    ...
    String sql = "SELECT task.id, user_id, type_id, title, detail, deadline, comment,  type_id FROM task  INNER JOIN task_type ON task.type_id = task_type.id where type_id = ?";
